...
var sendSplits = /** @class */ (function (_super) {
    __extends(sendSplits, _super);
    function sendSplits() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.send = function (address, chain_id, mnemonic, fromID, toID, ownableID, split, feesAmount, feesToken, gas, mode, memo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.createSplitsSendMsg = function (address, chain_id, fromID, toID, ownableID, split, feesAmount, feesToken, gas, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, options;
            return __generator(this, function (_a) {
                path = this.path;
                options = {
