...
exports.getAccount = function (address, path) {
    return node_fetch_1["default"](path + config.getAccount + address)
        .then(function (response) { return response.json(); })["catch"](function (err) { return console.log(JSON.stringify(err)); });
};
    ...
    return new es6_promise_1.Promise(function (resolve, reject) {
        switch (type) {
            ...
            case "classifications":
                list.forEach(function (value) {
                    if (value.value.immutableProperties.value.properties.value.propertyList[0].value.id.value.idString === id) {
