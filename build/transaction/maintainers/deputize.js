...
class deputizeMaintainer extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.deputize = async (address, chain_id, mnemonic, identityID, clsID, toID, maintainedTraits, addMaintainer, removeMaintainer, mutateMaintainer, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createDeputizeMsg = async (address, chain_id, identityID, clsID, toID, maintainedTraits, addMaintainer, removeMaintainer, mutateMaintainer, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.deputizePath,
