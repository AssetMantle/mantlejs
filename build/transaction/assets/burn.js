...
class burnAsset extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.burn = async (address, chain_id, mnemonic, fromID, assetID, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createAssetBurnMsg = async (address, chain_id, fromID, assetID, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.burnAssetPath,
