...
var bank = /** @class */ (function (_super) {
    ...
    function bank() {
        ...
        _this.sendCoin = function (from_address, chain_id, to_address, mnemonic, denom, amount, feesAmount, feesToken, gas, mode, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, wallet, options;
        ...
        _this.createSendCoinMsg = function (from_address, chain_id, to_address, denom, amount, feesAmount, feesToken, gas, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, options;
            return __generator(this, function (_a) {
                path = this.path;
                options = {
