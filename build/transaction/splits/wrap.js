...
class wrapSplits extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.wrap = async (address, chain_id, mnemonic, fromID, coins, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createSplitsWrapMsg = async (address, chain_id, fromID, coins, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.wrapCoinPath,
