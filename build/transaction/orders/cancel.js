...
class cancelOrder extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.cancel = async (address, chain_id, mnemonic, fromID, orderID, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createOrderCancelMsg = async (address, chain_id, fromID, orderID, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.cancelOrderPath,
