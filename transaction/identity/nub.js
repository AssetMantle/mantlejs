...
var nubIdentity = /** @class */ (function (_super) {
    ...
    function nubIdentity() {
        ...
        _this.nub = function (address, chain_id, mnemonic, nubID, feesAmount, feesToken, gas, mode, memo) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.createIdentityNubMsg = function (address, chain_id, nubID, feesAmount, feesToken, gas, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, options;
            return __generator(this, function (_a) {
                path = this.path;
                options = {
