...
var revealMeta = /** @class */ (function (_super) {
  ...
  function revealMeta() {
    ...
    _this.reveal = function (address, chain_id, mnemonic, metaFact, feesAmount, feesToken, gas, mode, memo) {
    ...
    _this.createMetaRevealMsg = function (address, chain_id, metaFact, feesAmount, feesToken, gas, memo) {
      return __awaiter(_this, void 0, void 0, function () {
        var path, options;
        return __generator(this, function (_a) {
          path = this.path;
