...
class revealMeta extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.reveal = async (address, chain_id, mnemonic, metaFact, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createMetaRevealMsg = async (address, chain_id, metaFact, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.metaRevealPath,
