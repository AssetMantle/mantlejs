...
var defineOrder = /** @class */ (function (_super) {
    __extends(defineOrder, _super);
    function defineOrder() {
        ...
        _this.createOrderDefineMsg = function (address, chain_id, fromID, mutableProperties, immutableProperties, mutableMetaProperties, immutableMetaProperties, feesAmount, feesToken, gas, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, options;
            return __generator(this, function (_a) {
                path = this.path;
                options = {
