        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    ...
                    return [4 /*yield*/, sendCoin.sendCoin(wallet.address, config.chain_id, wallet.address, mnemonic, "stake", "1000000", 25, "stake", 200000, "block", "")];
                case 7:
                    res = _a.sent();
                ...
                case 26:
                    ...
                    return [4 /*yield*/, identityProvision.provision(wallet.address, config.chain_id, mnemonic, identityID1, randomWallet.address, 25, "stake", 200000, "block", "")];
                case 27:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 28:
                    ...
                    return [4 /*yield*/, identityUnprovision.unprovision(wallet.address, config.chain_id, mnemonic, identityID1, randomWallet.address, 25, "stake", 200000, "block", "")];
                case 29:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 30:
                    ...
                    return [4 /*yield*/, assetDefine.define(wallet.address, config.chain_id, mnemonic, identityID1, "ASSET1:S|num1,burn:H|1", "ASSET2:S|", "ASSET3:S|num3", "ASSET4:S|num4", 25, "stake", 200000, "block", "")];
                case 31:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 32:
                ...
                case 34:
                    ...
                    return [4 /*yield*/, assetMint.mint(wallet.address, config.chain_id, mnemonic, identityID1, identityID1, assetClsID, "ASSET1:S|num1,burn:H|1", "ASSET2:S|num2", "ASSET3:S|num3", "ASSET4:S|num4", 25, "stake", 200000, "block", "")];
                case 35:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 36:
                ...
                case 38:
                    ...
                    return [4 /*yield*/, assetMutate.mutate(wallet.address, config.chain_id, mnemonic, identityID1, assetID, "ASSET1:S|", "ASSET3:S|num3", 25, "stake", 200000, "block", "")];
                case 39:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 40:
                    ...
                    return [4 /*yield*/, assetDefine.define(wallet.address, config.chain_id, mnemonic, identityID1, "ASSET5:S|num1,burn:H|1", "ASSET6:S|", "ASSET7:S|num3", "ASSET8:S|num4", 25, "stake", 200000, "block", "")];
                case 41:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 42:
                ...
                case 44:
                    ...
                    return [4 /*yield*/, assetMint.mint(wallet.address, config.chain_id, mnemonic, identityID1, identityID1, assetClsID1, "ASSET5:S|num1,burn:H|1", "ASSET6:S|num2", "ASSET7:S|num3", "ASSET8:S|num4", 25, "stake", 200000, "block", "")];
                case 45:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 46:
                ...
                case 48:
                    ...
                    return [4 /*yield*/, splitsSend.send(wallet.address, config.chain_id, mnemonic, identityID1, identityID2, assetID1, "0.000000000000000001", 25, "stake", 200000, "block", "")];
                case 49:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 50:
                    ...
                    return [4 /*yield*/, maintainerDeputize.deputize(wallet.address, config.chain_id, mnemonic, identityID1, assetClsID1, identityID2, "ASSET5:S|num1,burn:H|1,ASSET7:S|num3", true, true, true, 25, "stake", 200000, "block", "")];
                case 51:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 52:
                    ...
                    return [4 /*yield*/, assetMutate.mutate(wallet.address, config.chain_id, mnemonic, identityID2, assetID1, "ASSET5:S|,burn:H|1", "ASSET7:S|num3", 25, "stake", 200000, "block", "")];
                case 53:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 54:
                    ...
                    return [4 /*yield*/, metaReveal.reveal(wallet.address, config.chain_id, mnemonic, "H|1", 25, "stake", 200000, "block", "")];
                case 55:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 56:
                    ...
                    return [4 /*yield*/, splitsWrap.wrap(wallet.address, config.chain_id, mnemonic, identityID1, "100000stake", 25, "stake", 200000, "block", "")];
                case 57:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 58:
                    ...
                    return [4 /*yield*/, splitsUnwrap.unwrap(wallet.address, config.chain_id, mnemonic, identityID1, "stake", "100", 25, "stake", 200000, "block", "")];
                case 59:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 60:
                    ...
                    return [4 /*yield*/, splitsSend.send(wallet.address, config.chain_id, mnemonic, identityID1, identityID2, "stake", "499", 25, "stake", 200000, "block", "")];
                case 61:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 62:
                ...
                case 66:
                    ...
                    return [4 /*yield*/, orderMake.make(wallet.address, config.chain_id, mnemonic, identityID2, orderCls, "stake", "stake", "100000", "0.000000000000000001", "description:S|awesomeChocolates", "Which Gift:S|Christmas Gift,What Gift:S|Chocolates", "exchangeRate:D|1", "Gift:S|Exchange,AmazonOrderID:S|1234", 25, "stake", 200000, "block", "")];
                case 67:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 68:
                ...
                case 70:
                    listResponse = _a.sent();
                    orderID = listResponse.classificationID +
                        "*" +
                        ...
                        "*" +
                        listResponse.hashID;
                    return [4 /*yield*/, orderCancel.cancel(wallet.address, config.chain_id, mnemonic, identityID2, orderID, 25, "stake", 200000, "block", "")];
                case 71:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 72:
                ...
                case 74:
                    ...
                    return [4 /*yield*/, orderTake.take(wallet.address, config.chain_id, mnemonic, identityID2, "0.000000000000000001", orderID, 25, "stake", 200000, "block", "")];
                case 75:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 76:
                    ...
                    return [4 /*yield*/, assetBurn.burn(wallet.address, config.chain_id, mnemonic, identityID1, assetID, "25", "stake", "200000", "block", "")];
                case 77:
                    res = _a.sent();
                    return [4 /*yield*/, helper_1.checkRawLog(res.rawLog)];
                case 78:
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, identityNub.nub(address, chain_id, mnemonic, nubID, fee, token, gas, mode, "")];
                                case 1:
                                    result = _a.sent();
                                    resolve(result);
                                    return [2 /*return*/];
