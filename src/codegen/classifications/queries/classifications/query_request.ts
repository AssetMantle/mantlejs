...
export interface QueryRequestProtoMsg {
  typeUrl: "/assetmantle.modules.classifications.queries.classifications.QueryRequest";
  value: Uint8Array;
}
...
export interface QueryRequestAminoMsg {
  type: "/assetmantle.modules.classifications.queries.classifications.QueryRequest";
