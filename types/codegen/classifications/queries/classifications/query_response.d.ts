...
export interface QueryResponseProtoMsg {
    typeUrl: "/assetmantle.modules.classifications.queries.classifications.QueryResponse";
    value: Uint8Array;
}
...
export interface QueryResponseAminoMsg {
    type: "/assetmantle.modules.classifications.queries.classifications.QueryResponse";
