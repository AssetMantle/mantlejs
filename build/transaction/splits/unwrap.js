...
class unwrapsplits extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.unwrap = async (address, chain_id, mnemonic, fromID, ownableID, split, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createSplitsUnwrapMsg = async (address, chain_id, fromID, ownableID, split, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.unwrapCoinPath,
