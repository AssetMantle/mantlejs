...
var defineIdentity = /** @class */ (function (_super) {
    ...
    function defineIdentity() {
        ...
        _this.createIdentityDefineMsg = function (address, chain_id, fromID, mutableTraits, immutableTraits, mutableMetaTraits, immutableMetaTraits, feesAmount, feesToken, gas, memo) { return __awaiter(_this, void 0, void 0, function () {
            var path, options;
            return __generator(this, function (_a) {
                path = this.path;
                options = {
