...
export interface TransactionResponseProtoMsg {
  typeUrl: "/AssetMantle.modules.identities.transactions.update.TransactionResponse";
  value: Uint8Array;
}
export interface TransactionResponseAmino {}
export interface TransactionResponseAminoMsg {
  type: "/AssetMantle.modules.identities.transactions.update.TransactionResponse";
