...
class defineAsset extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        this.define = async (address, chain_id, mnemonic, fromID, mutableTraits, immutableTraits, mutableMetaTraits, immutableMetaTraits, feesAmount, feesToken, gas, mode, memo) => {
        ...
        this.createAssetDefineMsg = async (address, chain_id, fromID, mutableTraits, immutableTraits, mutableMetaTraits, immutableMetaTraits, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.defineAssetPath,
