...
class defineOrder extends persistenceJS_1.Persistence {
    constructor() {
        super(...arguments);
        ...
        this.createOrderDefineMsg = async (address, chain_id, fromID, mutableTraits, immutableTraits, mutableMetaTraits, immutableMetaTraits, feesAmount, feesToken, gas, memo) => {
            let path = this.path;
            let options = {
                method: "POST",
                url: path + config.defineOrderPath,
